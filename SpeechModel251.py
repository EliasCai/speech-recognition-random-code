...
class ModelSpeech(): # 语音模型类
    def __init__(self, datapath):
        ...
        model_path = 'model_speech/speech_model251_e_0_step_100.model'
    ...
    def TrainModel(self, datapath, epoch = 2, save_step = 1000, batch_size = 32, filename = abspath + 'model_speech/m' + ModelName + '/speech_model'+ModelName):
        ...
        validdatas = next(data.data_genetator(300, self.AUDIO_LENGTH, type='test'))
        ...
        for epoch in range(epoch): # 迭代轮数
            ...
            while True:
                try:
                    ...
                    self._model.fit_generator(yielddatas, save_step, validation_data=validdatas)
                    n_step += 1
    ...
    def SaveModel(self,filename = abspath + 'model_speech/speech_model'+ModelName,comment=''):
        '''
        保存模型参数
        '''
